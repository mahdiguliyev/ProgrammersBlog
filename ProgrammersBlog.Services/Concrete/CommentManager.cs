...
namespace ProgrammersBlog.Services.Concrete
{
    public class CommentManager: ManagerBase, ICommentService
    {
        ...
        public async Task<IDataResult<CommentDto>> AddAsync(CommentAddDto commentAddDto)
        {
            ...
            if (article == null)
            {
                return new DataResult<CommentDto>(ResultStatus.Error, Messages.Article.NotFoundMessage(isPlural:false), null);
            }
        ...
        public async Task<IDataResult<CommentDto>> ApproveAsync(int commentId, string modifiedByName)
        {
            ...
            if (comment != null)
            {
                ...
                return new DataResult<CommentDto>(ResultStatus.Success, Messages.Comment.ApproveMessage(commentId), new CommentDto
                {
                    Comment = updatedComment
                });
            }
