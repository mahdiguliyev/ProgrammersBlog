...
namespace ProgrammersBlog.Services.Concrete
{
    public class MailManager : IMailService
    {
        ...
        public IResult Send(EmailSendDto emailSendDto)
        {
            ...
            return new Result(ResultStatus.Success, "E-mailiniz göndərildi.");
        }
        ...
        public IResult SendContactEmail(EmailSendDto emailSendDto)
        {
            ...
            {
                From = new MailAddress(_smtpSettings.SenderEmail),
                To = { new MailAddress("quliyev.mehdi.1997@gmail.com") },
                Subject = emailSendDto.Subject,
                IsBodyHtml = true,
                Body = $"Göndərən şəxs: {emailSendDto.Name}, Göndərənin E-mail Adresi: {emailSendDto.Email}<br />{emailSendDto.Message}" 
            };
            SmtpClient smtpClient = new SmtpClient
            {
                Host = _smtpSettings.Server,
