...
namespace ProgrammersBlog.MVC.Controllers
{
    public class ArticleController : Controller
    {
        ...
        {
            var articlesResult = await _articleService.GetAsync(articleId);
            if (articlesResult.ResultStatus == ResultStatus.Success)
            {
                var userArticles = await _articleService.GetAllByUserIdOnFilter(articlesResult.Data.Article.UserId, _articleRightSideBarWidgetOptions.FilterBy,
                ...
                {
                    ArticleDto = articlesResult.Data,
                    ArticleDetailRightSideBarViewModel = new ArticleDetailRightSideBarViewModel
                    {
                        ...
                        User = articlesResult.Data.Article.User
                    }
                });
            }
