                ...
                if (isValid) {
                    const newSingleComment = `
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/men/19.jpg" alt="">
                    ...
                    toastr.success(`${commentAddAjaxModel.CommentDto.Comment.CreatedByName}, sizin kommentiniz uğurla əlavə edildi. Lakin sizin kommentinizin görüntülənməsi üçün Administrator tərəfindən təstiqlənməlidir!`);
