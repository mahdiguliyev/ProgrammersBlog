$(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            toastr.success(`${userAddAjaxModel.UserDto.Message}`, 'Operation Failed!');
                        } else {
                            let summaryText = "";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (userDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Deleted!',
                                    `"${userDto.User.UserName}" user has been deleted successfully.`,
                                    'success'
                                );
    ...
    /* Ajax GET / Deleting the User ends here. */
    ...
    /* Ajax GET / Getting the _RoleAssignPartial as Modal Form starts from here. */
    ...
    $(function () {
        ...
        /* Ajax POST / Updating a Role Assing starts from here */
            ...
            function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        const newFormBody = $('.modal-body', userRoleAssignAjaxModel.RoleAssingPartial);
                        placeHolderDiv.find('.modal-body').replaceWith(newFormBody);
                        const isValid = newFormBody.find('[name="IsValid"]').val() === 'True';
                        if (isValid) {
                            ...
                            const tableRow = $(`[name="${id}"]`);
                            placeHolderDiv.find('.modal').modal('hide');
                            toastr.success(`${userRoleAssignAjaxModel.UserDto.Message}`, "Success Operation!");
                        } else {
                            let summaryText = "";
                            $('#validation-summary > ul > li').each(function () {
                                let text = $(this).text();
        ...
        /* Ajax POST / Updating a Role ends here */
