        ...
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            builder.HasData(
                new Article
                {
                    ...
                    SeoDescription = "C# 9.0 ve .NET 5 Updates",
                    SeoTags = "C#, C# 9, .NET5, .NET Framework, .NET Core",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                ...
                new Article
                {
                    Id = 3,
                    CategoryId = 3,
                    Title = "JavaScript ES2019 and ES2020 Updates",
                    Content =
                    ...
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "JavaScript ES2019 ve ES2020 Updates",
                    SeoTags = "JavaScript ES2019 ve ES2020 Updates",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                    ...
                    ModifiedByName = "InitialCreate",
                    ModifiedDate = DateTime.Now,
                    Note = "JavaScript ES2019 and ES2020 Updates",
                    UserId = 1,
                    ViewsCount = 12,
                    CommentsCount = 0
                }
                ...
                new Article
                {
                    ...
                    SeoTags = "Typescript 4.1 Updates",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                ...
                new Article
                {
                    Id = 5,
                    CategoryId = 5,
                    Title = "Java and Android's Future | 2021",
                    Content =
                        "Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz. Kökleri M.Ö. 45 tarihinden bu yana klasik Latin edebiyatına kadar uzanan 2000 yıllık bir geçmişi vardır. Virginia'daki Hampden-Sydney College'dan Latince profesörü Richard McClintock, bir Lorem Ipsum pasajında geçen ve anlaşılması en güç sözcüklerden biri olan 'consectetur' sözcüğünün klasik edebiyattaki örneklerini incelediğinde kesin bir kaynağa ulaşmıştır. Lorm Ipsum, Çiçero tarafından M.Ö. 45 tarihinde kaleme alınan \"de Finibus Bonorum et Malorum\" (İyi ve Kötünün Uç Sınırları) eserinin 1.10.32 ve 1.10.33 sayılı bölümlerinden gelmektedir. Bu kitap, ahlak kuramı üzerine bir tezdir ve Rönesans döneminde çok popüler olmuştur. Lorem Ipsum pasajının ilk satırı olan \"Lorem ipsum dolor sit amet\" 1.10.32 sayılı bölümdeki bir satırdan gelmektedir. 1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri ilgilenenler için yeniden üretilmiştir. Çiçero tarafından yazılan 1.10.32 ve 1.10.33 bölümleri de 1914 H. Rackham çevirisinden alınan İngilizce sürümleri eşliğinde özgün biçiminden yeniden üretilmiştir.",
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "Java, Android, Mobile, Kotlin, Mobile Development",
                ...
                new Article
                {
                    Id = 6,
                    CategoryId = 6,
                    Title = "Data Analytics with Python | 2021",
                    Content =
                    ...
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "Data Analytics with Python",
                    SeoTags = "Python, How is Data Mining Done?",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                ...
                new Article
                {
                    Id = 7,
                    CategoryId = 7,
                    Title = "Php Laravel Getting Started Guide | API",
                    Content =
                    ...
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "Php - Creating API Guide",
                ...
                new Article
                {
                    Id = 8,
                    CategoryId = 8,
                    Title = "Kotlin for Mobile Programming",
                    Content =
                    ...
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "Kotlin for Mobile Programming Step by Step A-Z",
                    SeoTags = "kotlin, android, mobile, programming",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                ...
                new Article
                {
                    Id = 9,
                    CategoryId = 9,
                    Title = "Swift for IOS Programming",
                    Content =
                    ...
                    Thumbnail = "postImages/defaultThumbnail.jpg",
                    SeoDescription = "Swift for IOS Programming Step by Step A-Z",
                    SeoTags = "IOS, android, mobile, programming",
                    SeoAuthor = "Guliyev Mahdi",
                    Date = DateTime.Now,
                    IsActive = true,
                    IsDeleted = false,
                ...
                new Article
                {
                    Id = 10,
                    CategoryId = 10,
                    Title = "Ruby on Rails for AirBnb Klon Coding",
                    Content =
